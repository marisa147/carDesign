# Milestone v2.0: V2 MVP Roadmap Archive
...
This archive preserves the full v2.0 roadmap as it stood at milestone close. For current project status, see `.planning/ROADMAP.md`.
