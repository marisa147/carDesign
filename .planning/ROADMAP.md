...
- [ ] 08-01-PLAN.md — V1 release baseline, verification inventory, and regression command index.
- [ ] 08-02-PLAN.md — V2 feature flag scaffold, environment guards, and default-off rollout settings.
- [ ] 08-03-PLAN.md — Contract compatibility check for V1 workbench, jobs, artifacts, versions, and PreviewSpec.
...
- [ ] 09-01-PLAN.md — Hosted image provider capability map and typed runtime configuration.
- [ ] 09-02-PLAN.md — Hosted provider adapter implementation behind existing provider boundary.
- [ ] 09-03-PLAN.md — Hosted preflight integration with quota, rate-limit, runtime mode, and provider health.
...
- [ ] 10-01-PLAN.md — EditIntent, EditRegion, mask asset, and prompt-delta schema.
- [ ] 10-02-PLAN.md — Workbench region/layer selection model and mask preview controls.
...
- [ ] 10-07-PLAN.md — Version comparison UI for targeted edits and changed-region highlighting.
...
- [ ] 11-01-PLAN.md — Reference role schema, rights snapshot, and provider capability contract.
- [ ] 11-02-PLAN.md — Asset library UI updates for assigning reference roles and generation eligibility.
- [ ] 11-03-PLAN.md — Prompt planner/reference planner integration and unsupported-capability warnings.
- [ ] 11-04-PLAN.md — Hosted/local provider reference handling and deterministic fallback behavior.
- [ ] 11-05-PLAN.md — Reference trace persistence in model runs, artifacts, versions, and exports.
...
- [ ] 12-05-PLAN.md — Screenshot capture, artifact persistence, and version linkage.
...
- [ ] 13-01-PLAN.md — HandoffPackage schema, manifest version, and export-type taxonomy.
- [ ] 13-02-PLAN.md — Safe-zone/warning report renderer and concept-only disclaimer contract.
- [ ] 13-03-PLAN.md — ZIP package builder with images, screenshots, manifest, and handoff notes.
- [ ] 13-04-PLAN.md — Export ledger updates, immutable package artifacts, and lineage linkage.
- [ ] 13-05-PLAN.md — Workbench export dialog, package preview, history, and download UX.
